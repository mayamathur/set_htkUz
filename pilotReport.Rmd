...
All the reported numbers in Table 1 (page 104) of the paper are replicated in the table above.
...
Below, I replicate the above analysis in R:
...
All the significant results reported are successfully replicated. The effect size $\eta_p^2$ is also accurately reported.
...
This report successfully reproduced all the descriptive statistics reported in the original paper. It also successfully reproduced the analyses reported in the target outcome above. The only problem encountered was that the data provided was not readily useful and needed cleanup. It is preferable if data is provided in a tidy format.
