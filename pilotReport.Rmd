...
aga_months (7.5 vs. 8.5) 
condition (middle vs. side)
event (narrow vs. wide)

contrasts(main_data$event)

summary(model)


aov(LT ~ age_months * condition * event, data=main_data)$coefficients
